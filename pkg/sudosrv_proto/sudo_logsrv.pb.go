...
func (m *ClientMessage) GetEvent() isClientMessage_Event {
	if m != nil {
		return m.Event
	}
	return nil
...
func (x *ClientMessage) GetHelloMsg() *ClientHello {
	if x, ok := x.GetEvent().(*ClientMessage_HelloMsg); ok {
		return x.HelloMsg
	}
	return nil
}
...
func (x *ClientMessage) GetAcceptMsg() *AcceptMessage {
	if x, ok := x.GetEvent().(*ClientMessage_AcceptMsg); ok {
		return x.AcceptMsg
	}
	return nil
}
...
func (x *ClientMessage) GetRejectMsg() *RejectMessage {
	if x, ok := x.GetEvent().(*ClientMessage_RejectMsg); ok {
		return x.RejectMsg
	}
	return nil
}
...
func (x *ClientMessage) GetExitMsg() *ExitMessage {
	if x, ok := x.GetEvent().(*ClientMessage_ExitMsg); ok {
		return x.ExitMsg
	}
	return nil
}
...
func (x *ClientMessage) GetRestartMsg() *RestartMessage {
	if x, ok := x.GetEvent().(*ClientMessage_RestartMsg); ok {
		return x.RestartMsg
	}
	return nil
}
...
func (x *ClientMessage) GetAlertMsg() *AlertMessage {
	if x, ok := x.GetEvent().(*ClientMessage_AlertMsg); ok {
		return x.AlertMsg
	}
	return nil
}
...
func (x *ClientMessage) GetTtyinBuf() *IoBuffer {
	if x, ok := x.GetEvent().(*ClientMessage_TtyinBuf); ok {
		return x.TtyinBuf
	}
	return nil
}
...
func (x *ClientMessage) GetTtyoutBuf() *IoBuffer {
	if x, ok := x.GetEvent().(*ClientMessage_TtyoutBuf); ok {
		return x.TtyoutBuf
	}
	return nil
}
...
func (x *ClientMessage) GetStdinBuf() *IoBuffer {
	if x, ok := x.GetEvent().(*ClientMessage_StdinBuf); ok {
		return x.StdinBuf
	}
	return nil
}
...
func (x *ClientMessage) GetStdoutBuf() *IoBuffer {
	if x, ok := x.GetEvent().(*ClientMessage_StdoutBuf); ok {
		return x.StdoutBuf
	}
	return nil
}
...
func (x *ClientMessage) GetStderrBuf() *IoBuffer {
	if x, ok := x.GetEvent().(*ClientMessage_StderrBuf); ok {
		return x.StderrBuf
	}
	return nil
}
...
func (x *ClientMessage) GetWinsizeEvent() *ChangeWindowSize {
	if x, ok := x.GetEvent().(*ClientMessage_WinsizeEvent); ok {
...
func (x *ClientMessage) GetSuspendEvent() *CommandSuspend {
	if x, ok := x.GetEvent().(*ClientMessage_SuspendEvent); ok {
...
type ClientMessage_HelloMsg struct {
	HelloMsg *ClientHello `protobuf:"bytes,1,opt,name=hello_msg,json=helloMsg,proto3,oneof"`
}

type ClientMessage_AcceptMsg struct {
	AcceptMsg *AcceptMessage `protobuf:"bytes,2,opt,name=accept_msg,json=acceptMsg,proto3,oneof"`
}

type ClientMessage_RejectMsg struct {
	RejectMsg *RejectMessage `protobuf:"bytes,3,opt,name=reject_msg,json=rejectMsg,proto3,oneof"`
}

type ClientMessage_ExitMsg struct {
	ExitMsg *ExitMessage `protobuf:"bytes,4,opt,name=exit_msg,json=exitMsg,proto3,oneof"`
}

type ClientMessage_RestartMsg struct {
	RestartMsg *RestartMessage `protobuf:"bytes,5,opt,name=restart_msg,json=restartMsg,proto3,oneof"`
}

type ClientMessage_AlertMsg struct {
	AlertMsg *AlertMessage `protobuf:"bytes,6,opt,name=alert_msg,json=alertMsg,proto3,oneof"`
}

type ClientMessage_TtyinBuf struct {
	TtyinBuf *IoBuffer `protobuf:"bytes,7,opt,name=ttyin_buf,json=ttyinBuf,proto3,oneof"`
}

type ClientMessage_TtyoutBuf struct {
	TtyoutBuf *IoBuffer `protobuf:"bytes,8,opt,name=ttyout_buf,json=ttyoutBuf,proto3,oneof"`
}

type ClientMessage_StdinBuf struct {
	StdinBuf *IoBuffer `protobuf:"bytes,9,opt,name=stdin_buf,json=stdinBuf,proto3,oneof"`
}

type ClientMessage_StdoutBuf struct {
	StdoutBuf *IoBuffer `protobuf:"bytes,10,opt,name=stdout_buf,json=stdoutBuf,proto3,oneof"`
}

type ClientMessage_StderrBuf struct {
	StderrBuf *IoBuffer `protobuf:"bytes,11,opt,name=stderr_buf,json=stderrBuf,proto3,oneof"`
}

type ClientMessage_WinsizeEvent struct {
	WinsizeEvent *ChangeWindowSize `protobuf:"bytes,12,opt,name=winsize_event,json=winsizeEvent,proto3,oneof"`
}

type ClientMessage_SuspendEvent struct {
	SuspendEvent *CommandSuspend `protobuf:"bytes,13,opt,name=suspend_event,json=suspendEvent,proto3,oneof"`
}

func (*ClientMessage_HelloMsg) isClientMessage_Event() {}

func (*ClientMessage_AcceptMsg) isClientMessage_Event() {}

func (*ClientMessage_RejectMsg) isClientMessage_Event() {}

func (*ClientMessage_ExitMsg) isClientMessage_Event() {}

func (*ClientMessage_RestartMsg) isClientMessage_Event() {}

func (*ClientMessage_AlertMsg) isClientMessage_Event() {}

func (*ClientMessage_TtyinBuf) isClientMessage_Event() {}

func (*ClientMessage_TtyoutBuf) isClientMessage_Event() {}

func (*ClientMessage_StdinBuf) isClientMessage_Event() {}

func (*ClientMessage_StdoutBuf) isClientMessage_Event() {}

func (*ClientMessage_StderrBuf) isClientMessage_Event() {}

func (*ClientMessage_WinsizeEvent) isClientMessage_Event() {}

func (*ClientMessage_SuspendEvent) isClientMessage_Event() {}
...
func (x *ServerMessage) GetHello() *ServerHello {
	if x, ok := x.GetEvent().(*ServerMessage_Hello); ok {
		return x.Hello
	}
	return nil
}
...
func (x *ServerMessage) GetCommitPoint() *TimeSpec {
	if x, ok := x.GetEvent().(*ServerMessage_CommitPoint); ok {
...
func (x *ServerMessage) GetLogId() string {
	if x, ok := x.GetEvent().(*ServerMessage_LogId); ok {
		return x.LogId
	}
	return ""
}
...
func (x *ServerMessage) GetAbort() string {
	if x, ok := x.GetEvent().(*ServerMessage_Abort); ok {
		return x.Abort
	}
	return ""
}
...
func (*ServerMessage_Hello) isServerMessage_Event() {}

func (*ServerMessage_CommitPoint) isServerMessage_Event() {}

func (*ServerMessage_LogId) isServerMessage_Event() {}

func (*ServerMessage_Error) isServerMessage_Event() {}

func (*ServerMessage_Abort) isServerMessage_Event() {}
...
func (x *InfoMessage) GetStrlistval() *StringList {
...
func (x *InfoMessage) GetNumlistval() *NumberList {
...
type InfoMessage_Strlistval struct {
	Strlistval *StringList `protobuf:"bytes,4,opt,name=strlistval,proto3,oneof"`
}

type InfoMessage_Numlistval struct {
	Numlistval *NumberList `protobuf:"bytes,5,opt,name=numlistval,proto3,oneof"`
}
...
type AcceptMessage struct {
	...
	ExpectIobufs bool           `protobuf:"varint,2,opt,name=expect_iobufs,json=expectIobufs,proto3" json:"expect_iobufs,omitempty"`
...
type ExitMessage struct {
	...
	ExitValue  uint32    `protobuf:"varint,2,opt,name=exit_value,json=exitValue,proto3" json:"exit_value,omitempty"`
...
func (x *ExitMessage) GetExitValue() uint32 {
	if x != nil {
		return x.ExitValue
	}
	return 0
...
func (x *ChangeWindowSize) GetRows() uint32 {
	if x != nil {
		return x.Rows
	}
	return 0
...
func (x *ChangeWindowSize) GetCols() uint32 {
	if x != nil {
		return x.Cols
	}
	return 0
...
var file_sudo_logsrv_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0x82, 0x01, 0x0a, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	...
	0x08, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x73, 0x75, 0x62, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e,
	0x64, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x73, 0x75, 0x62, 0x63, 0x6f, 0x6d,
	0x6d, 0x61, 0x6e, 0x64, 0x73, 0x22, 0xa7, 0x01, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74,
	...
	,
	...
	,
...
var file_sudo_logsrv_proto_depIdxs = []int32{
	6,  // 0: sudosrv_proto.ClientMessage.hello_msg:type_name -> sudosrv_proto.ClientHello
	8,  // 1: sudosrv_proto.ClientMessage.accept_msg:type_name -> sudosrv_proto.AcceptMessage
	9,  // 2: sudosrv_proto.ClientMessage.reject_msg:type_name -> sudosrv_proto.RejectMessage
	10, // 3: sudosrv_proto.ClientMessage.exit_msg:type_name -> sudosrv_proto.ExitMessage
	11, // 4: sudosrv_proto.ClientMessage.restart_msg:type_name -> sudosrv_proto.RestartMessage
	12, // 5: sudosrv_proto.ClientMessage.alert_msg:type_name -> sudosrv_proto.AlertMessage
	13, // 6: sudosrv_proto.ClientMessage.ttyin_buf:type_name -> sudosrv_proto.IoBuffer
	13, // 7: sudosrv_proto.ClientMessage.ttyout_buf:type_name -> sudosrv_proto.IoBuffer
	13, // 8: sudosrv_proto.ClientMessage.stdin_buf:type_name -> sudosrv_proto.IoBuffer
	13, // 9: sudosrv_proto.ClientMessage.stdout_buf:type_name -> sudosrv_proto.IoBuffer
	13, // 10: sudosrv_proto.ClientMessage.stderr_buf:type_name -> sudosrv_proto.IoBuffer
	14, // 11: sudosrv_proto.ClientMessage.winsize_event:type_name -> sudosrv_proto.ChangeWindowSize
	15, // 12: sudosrv_proto.ClientMessage.suspend_event:type_name -> sudosrv_proto.CommandSuspend
	...
	4,  // 15: sudosrv_proto.InfoMessage.strlistval:type_name -> sudosrv_proto.StringList
	5,  // 16: sudosrv_proto.InfoMessage.numlistval:type_name -> sudosrv_proto.NumberList
